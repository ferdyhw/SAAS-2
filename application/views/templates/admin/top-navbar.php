<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="<?= base_url('user/admin') ?>"><i class="fas fa-fw fa-school fa-lg mb-1"></i>&nbsp;&nbsp;&nbsp;&nbsp;<span>Absensi SMK 1</span></a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle"><i class="fas fa-bars fa-lg"></i>
            </button>
        ...
        <div class="modal fade" id="profile" tabindex="-1" role="dialog" aria-labelledby="profileLabel" aria-hidden="true">
          <div class="modal-dialog mt-1 mb-0" role="document">
            <div class="modal-content">
              ...
              <form action="<?= base_url('user/admin'); ?>" method="post" enctype="multipart/form-data">
              <div class="modal-body">                
