                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?= base_url('absensi/admin'); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Table Absen</a>
                            <a class="nav-link" href="<?= base_url('absensi/kehadiran'); ?>">
                                <div class="sb-nav-link-icon"><i class="far fa-calendar-check"></i></div>
                                Kehadiran</a>
                            <a class="nav-link" href="<?= base_url('absensi/pending'); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-check"></i></div>
                                Persetujuan</a>
                            <div class="sb-sidenav-menu-heading">Tambah</div>
                            <a class="nav-link" href="<?= base_url('absensi/tambah'); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-plus"></i></div>
                                Tambah Siswa</a>
                            <a class="nav-link" href="<?= base_url('absensi/signup'); ?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-user-plus"></i></div>
                                Tambah Akun</a>
