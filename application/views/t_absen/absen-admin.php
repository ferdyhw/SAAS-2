            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Table Absen Siswa
                            </div>
                            <div class="card-body">
                ...
                <?php foreach($siswa as $swa) : ?>
                  <div class="modal fade" id="Absensi<?= $swa['id_siswa'];?>" tabindex="-1" role="dialog" aria-labelledby="AbsensiLabel<? $swa['id_siswa'];?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      ...
                      <form class="form-horizontal" action="<?php echo base_url('absensi/admin')?>" method="post" enctype="multipart/form-data" role="form">
