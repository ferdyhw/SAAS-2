            <div id="layoutSidenav_content">
                                ...
                                <div class="table-responsive">
                                  ...
                                  <form method="post" action="" autocomplete>
                                    <div class="input-group">
                                      ...
                                      <input type="text" class="form-control mb-3" name="keyword" placeholder="Masukan Keyword Pencarian...">
                ...
                <!-- Modal Hapus -->
                <?php foreach($absensi as $swa) : ?>
                <div class="modal fade" id="Hapus<?= $swa['id_absen'];?>" tabindex="-1" role="dialog" aria-labelledby="HapusLabel<?= $swa['id_absen'];?>" aria-hidden="true">
                ...
                <!-- Modal Edit --> 
                <?php foreach($absensi as $swa) : ?>
                  <div class="modal fade" id="Absensi<?= $swa['id_absen'];?>" tabindex="-1" role="dialog" aria-labelledby="AbsensiLabel<? $swa['id_absen'];?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
